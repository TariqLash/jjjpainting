  ...
  return (
    ...
    <div className='mainForm flex justify-center items-center pt-5 pb-10 w-full'>
      <form ref={form} onSubmit={sendEmail} className='form rounded-xl w-full justify-around items-center shadow-xl bg-base-200 p-8 m-8 flex flex-col '>
        ...
        <input type="text" name='project_date' placeholder="Project Date" className="input w-full h-14 text-lg" />

        <textarea name='project_details' className="textarea w-full h-44 text-lg" placeholder="Project Details"></textarea>

        <input type="text" name='project_address' placeholder="Project Address" className="input w-full h-14 text-lg" />
        <input type="text" name="from_name" placeholder="Full Name" className="input w-full h-14 text-lg" />
        <input type="phone" name="phone_number" placeholder="Phone Number" className="input w-full h-14 text-lg" />
        <input type="email" name='user_email' placeholder="Email Address" className="input w-full h-14 text-lg" />
