    ...
    <div className="hero">
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-2xl">
          <h1 className="mb-5 text-5xl font-bold">At Home or at the Cabin</h1>
          <h3 className='mb-5 font-semibold'>Quality Painters for all your painting needs</h3>
          <p className="mb-5 text-justify w-full">JJJ Painting strives to deliver the highest-end results to our customers.
            ...
            1can count on us for all of your painting needs.
          </p>
